			...
			<div class="col-md-12">
				<div class="card-box">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input id="leadName"name="leadName"value="<?php if(isset($fetchValue[0]['leadName'])){echo set_value('leadName',$fetchValue[0]['leadName']);} ?>"class="form-control"placeholder="Name">
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label col-sm-4">Mobile</label>
						<div class="col-md-8">
							<input id="leadMobile"name="leadMobile"value="<?php if(isset($fetchValue[0]['leadMobile'])){echo set_value('leadMobile',$fetchValue[0]['leadMobile']);} ?>"class="form-control"placeholder="Title">
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label col-sm-4">Email</label>
						<div class="col-md-8">
							<input id="leadEmail"name="leadEmail"value="<?php if(isset($fetchValue[0]['leadEmail'])){echo set_value('leadEmail',$fetchValue[0]['leadEmail']);} ?>"class="form-control"placeholder="Email">
						</div>
					</div>
