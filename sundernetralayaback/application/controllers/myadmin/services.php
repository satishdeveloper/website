...
class Services extends CI_Controller{
	...
	public function __construct(){
		...
		$this->OOZPGINFO["TBL"]='services';
		$this->OOZPGINFO['PK']='SID';
		$this->folder_name='services';
	}
...
public function fetchdata(){$sSearch=$this->input->post('search');$table_name=$this->OOZPGINFO['TBL'];$select=''.$this->OOZPGINFO['TBL'].'.SID,
