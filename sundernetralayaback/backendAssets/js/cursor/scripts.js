    ...
    _createClass(V, [{
      ...
      value: function initCanvas() {
        ...
        t.setup(i);var n = !1;var s = new t.Path.RegularPolygon(new t.Point(0, 0), 8, 15);s.strokeColor = "rgba(255, 0, 0, 0.5)", s.strokeWidth = 1, s.smooth(), this.group = new t.Group([s]), this.group.applyMatrix = !1;var o = s.segments.map(function () {
          ...
          })), _this10.fillOuterCursor && "rgba(255, 0, 0, 0.5)" !== s.fillColor ? (s.fillColor = "rgba(255, 0, 0, 0.5)", s.strokeColor = "transparent") : _this10.fillOuterCursor || "transparent" === s.fillColor || (s.strokeColor = "rgba(200, 254, 80, 0.5)", s.fillColor = "transparent"), s.smooth();
        };//change strockcolor for change Cursor culor
      }
    }, {
      key: "initHovers",
      value: function initHovers() {
