						...
						<div class="box-content" id="AddEdit"><?php  ?><a class="btn btn-primary btn-rounded m-b-5 w-md waves-effect waves-light" href="<?php echo base_url(); ?>myadmin/<?php echo $this->router->fetch_class(); ?>/listview"><i class="ti-back-left"></i><?php echo 'Listview' ?></a><?php  ?>
							...
							<div class="form-group"><label class="col-lg-2 control-label col-sm-4">Image</label>
								<div class="col-md-8">
									...
									<small>Image dimention is (800*800)px and file size should be less then 200KB.</small>
								</div>
							</div>

							<div class="form-group"><label class="col-lg-2 control-label col-sm-4">Synopsis</label>
								<div class="col-md-8"><textarea class="form-control ckeditor col-md-12" id="synopsis" name="synopsis" rows="6"><?php if (isset($fetchValue[0]['synopsis'])) {
							...
							<div class="form-group"><label class="col-lg-2 control-label col-sm-4">Description</label>
								<div class="col-md-8"><textarea class="form-control ckeditor col-md-12" id="description" name="description" rows="6"><?php if (isset($fetchValue[0]['description'])) {
																																							echo set_value('description', $fetchValue[0]['description']);
																																						} ?></textarea></div>
							</div>

							<div class="form-group"><label class="col-lg-2 control-label col-sm-4">Utilities Heading</label>
								<div class="col-md-8"><input id="utilities_heading" name="utilities_heading" value="<?php if (isset($fetchValue[0]['utilities_heading'])) {
																														echo set_value('utilities_heading', $fetchValue[0]['utilities_heading']);
																													} ?>" class="form-control" placeholder="utilities_heading"></div>
							</div>
