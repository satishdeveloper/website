<?php if(!defined('BASEPATH'))exit('No direct script access allowed');class Carriers extends CI_Controller{

	public function __construct(){

		parent::__construct();$this->load->library('upload');$this->load->model('master_model');$this->OOZPGINFO["TBL"]='carriers';$this->OOZPGINFO['PK']='leadID';$this->folder_name='carriers';}
...
$select='*';
$where_like="(leadName LIKE '%".$sSearch['value']."%' or leadMobile LIKE '%".$sSearch['value']."%' or leadEmail LIKE '%".$sSearch['value']."%'  or serviceName LIKE '%".$sSearch['value']."%')";
