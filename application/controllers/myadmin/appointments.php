...
class Appointments extends CI_Controller{
	...
	public function __construct(){
		...
		parent::__construct();$this->load->library('upload');$this->load->model('master_model');$this->OOZPGINFO["TBL"]='appointments';$this->OOZPGINFO['PK']='id';$this->folder_name='appointment';}
...
$select='*';
$where_like="(name LIKE '%".$sSearch['value']."%' or mobile LIKE '%".$sSearch['value']."%' or email LIKE '%".$sSearch['value']."%')";
